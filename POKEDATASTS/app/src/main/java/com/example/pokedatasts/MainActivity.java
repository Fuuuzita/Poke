...
public class MainActivity extends AppCompatActivity  implements View.OnClickListener {
    public static final String[] DORYOKU_KOUHO = new String[]{"0","31"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AutoCompleteTextView textView = (AutoCompleteTextView) findViewById(R.id.EDITTEXT_KOTAITI_H);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.list_item, DORYOKU_KOUHO);
        textView.setAdapter(adapter);
         /*
        AutoCompleteTextView textViewA = (AutoCompleteTextView) findViewById(R.id.EDITTEXT_KOTAITI_A);
        ArrayAdapter<String> adapterA = new ArrayAdapter<String>(this, R.layout.activity_main, DORYOKU_KOUHO);
        textViewA.setAdapter(adapterA);
*/
